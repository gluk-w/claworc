...
> Part of the [Internal Proxy](./internal-proxy.md). The LLM gateway is the
...
| `control-plane/internal/internalproxy/keys.go` | Virtual key generation, `EnsureKeysForInstance`, `GetInstanceGatewayKeys` |
