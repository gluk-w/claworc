...
import { X, Eye, EyeOff, ExternalLink, Loader2, Settings, BarChart3 } from "lucide-react";
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h2 id="provider-modal-title" className="text-base font-semibold text-gray-900">
            {activeTab === "configure" ? "Configure" : "Stats"} {provider.name}
          </h2>
          <button
            type="button"
            onClick={handleClose}
        ...
        {/* Tabs */}
        <div className="flex border-b border-gray-200" role="tablist" aria-label="Provider modal tabs">
          <button
            type="button"
            role="tab"
            aria-selected={activeTab === "configure"}
            aria-controls="tab-panel-configure"
            data-testid="tab-configure"
            onClick={() => setActiveTab("configure")}
            className={`flex items-center gap-1.5 px-4 py-2.5 text-xs font-medium transition-colors duration-200 border-b-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset ${
              activeTab === "configure"
        ...
        {/* Configure Tab Panel */}
        {activeTab === "configure" && (
          <div id="tab-panel-configure" role="tabpanel">
            {/* Body */}
        ...
        {/* Stats Tab Panel */}
        {activeTab === "stats" && (
          <div id="tab-panel-stats" role="tabpanel" className="px-6 py-4">
            <ProviderStatsTab
